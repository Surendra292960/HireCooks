...
public class FirmUserList extends AppCompatActivity {
                 ...
                 for(Example example:response.body()){
                     if(!example.getError()){
                         ...
                         if(filtereduserList!=null&&filtereduserList.size()!=0){
                             adapter = new FirmUserAdapter( FirmUserList.this, filtereduserList);
                             usersRecyclerView.setAdapter(adapter);
                         }
                     }
                 }
    ...
    private void searchUserByName(String s) {
        ...
        try{
            ...
            adapter = new FirmUserAdapter ( FirmUserList.this, filteredList);
            usersRecyclerView.setAdapter (adapter);
    ...
    public class FirmUserAdapter extends RecyclerView.Adapter<FirmUserAdapter.ViewHolder> {
        ...
        private void showalertbox(User firm_user) {
            final android.app.AlertDialog.Builder dialogBuilder = new android.app.AlertDialog.Builder( FirmUserList.this);
            LayoutInflater inflater = FirmUserList.this.getLayoutInflater();
