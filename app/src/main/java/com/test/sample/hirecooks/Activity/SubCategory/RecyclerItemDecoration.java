...
public class RecyclerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if(headerView==null) {
           ...
           // tvTitle = (TextView)headerView.findViewById(R.id.tv_header);
    ...
    private void drawHeader(@NonNull Canvas c, View child, View headerView) {
        c.save();
        if(sticky) {
    ...
    private View inflateHeader(RecyclerView recyclerView) {
        View view= LayoutInflater.from(context).inflate(R.layout.view_header,recyclerView,false);
        return view;
    }
