...
public class Utils {
    ...
    public static final String ATTRIBUTE_SCHEMA = "http://schemas.android.com/apk/lib/com.sample.retailapp.util";
    ...
    public static final String MY_CART_FRAGMENT = "UsersFragment";
...
//
//	public static Maps<String, Integer> buildEffectMap(Context context) {
//		Maps<String, Integer> effectMap = new LinkedHashMap<>();
//		int i = 0;
    ...
    public static void switchContent(int id, String TAG,
     ...
     /*   if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
            ...
            if (fragment == null) {
                ...
                } else if (TAG.equals(USERS_FRAGMENT)) {
                    fragmentToReplace = new UsersFragment();
                } else if (TAG.equals(COOKS_FRAGMENT)) {
                    fragmentToReplace = new OrdersFragment();
                ...
                if (TAG.equals(HOME_FRAGMENT)) {
                    ...
                    fragmentToReplace = (UsersFragment) fragment;
                } else if (TAG.equals(COOKS_FRAGMENT)) {
                    fragmentToReplace = (OrdersFragment) fragment;
                } else if (TAG.equals(PROFILE_FRAGMENT)) {
