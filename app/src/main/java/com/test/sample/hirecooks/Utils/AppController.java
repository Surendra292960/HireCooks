...
@ReportsCrashes(mailTo = "surendrapal@outlook.com", customReportContent = {
...
public class AppController extends Application {
    ...
    public void onCreate() {
        ...
        if (SharedPrefManager.getInstance(this).getBoolean(this, SharedPrefManager.SUBMIT_LOGS, true)) {
            ACRA.init(this);
        }
    }
}