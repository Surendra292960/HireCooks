package com.test.sample.hirecooks.Activity.subscription;
...
import com.test.sample.hirecooks.Libraries.subscription.IabBroadcastReceiver;
import com.test.sample.hirecooks.Libraries.subscription.IabHelper;
import com.test.sample.hirecooks.Libraries.subscription.IabResult;
import com.test.sample.hirecooks.Libraries.subscription.Inventory;
import com.test.sample.hirecooks.Libraries.subscription.Purchase;
import com.test.sample.hirecooks.R;

import java.util.ArrayList;
import java.util.List;

import static com.test.sample.hirecooks.Utils.Constants.SKU_DELAROY_MONTHLY;
import static com.test.sample.hirecooks.Utils.Constants.SKU_DELAROY_SIXMONTH;
import static com.test.sample.hirecooks.Utils.Constants.SKU_DELAROY_THREEMONTH;
import static com.test.sample.hirecooks.Utils.Constants.SKU_DELAROY_YEARLY;
import static com.test.sample.hirecooks.Utils.Constants.base64EncodedPublicKey;
